                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item btn btn-outline-primary waves-effect waves-light" href="{{ route('product.create') }}?type=edit&id={{ $product->id }}"><i class="fe-edit"></i> Edit</a>

                                            <form action="{{route('product.destroy', $product->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Are you sure to Delete This product?')" class="dropdown-item btn btn-outline-danger"><i class="fe-trash"></i> Delete</button>
                                            </form>
