                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-6 align-items-center d-flex">
                            <h4 class="m-0">Post Category List</h4>
                        </div>
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                data-target="#signup-modal"><i class="fe-plus"></i> New Post Category</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" action="{{ route('post-categories.store') }}" method="POST"
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($category->id != 1)
                                                <form action="{{ route('post-categories.destroy', $category->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal"
                                                        action="{{ route('post-categories.update', $category->id) }}"
